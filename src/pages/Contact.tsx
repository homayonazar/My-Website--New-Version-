                ...
                <div className="contact ml-[270px] max-w-300 ">
                    <h2 className="text-4xl font-bold p-10  text-[var(--texttitle)] ">
                        ...
                        <div className="mainSec flex flex-col   my-5">
                            <div className="h2 text-center">Have You Any Question ?</div>
                            <p className="text-center">I'M AT YOUR SERVICE</p>
                            ...
                            <p className="text-center my-5">SEND ME AN EMAIL</p>
                            <p className="text-center my-5">I'M VERY RESPONSIVE TO MESSAGE</p>
                            <div className="contactForm flex flex-col">
                                <div className="firstRow flex flex-row gap-5">
                                    ...
                                    <input type="text" placeholder="Email" className="w-1/2 h-12 border-1 border-gray-300 bg-white rounded-3xl text-xl ps-4 font-normal outline-0" />
                                </div>
                                ...
                                <textarea name="" id="" placeholder="Message" className="w-full h-30 bg-white rounded-3xl font-normal text-xl p-5  outline-0"></textarea>
