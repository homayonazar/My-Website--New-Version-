...
function SideMenu() {
    ...
    return (
        <div>
            ...
            <div
                className={`fixed top-0 left-0 w-full opacity-95 sm:opacity-100 sm:w-[270px] h-full flex flex-col items-center bg-[var(--bgside)] transform transition-transform duration-300 z-40
